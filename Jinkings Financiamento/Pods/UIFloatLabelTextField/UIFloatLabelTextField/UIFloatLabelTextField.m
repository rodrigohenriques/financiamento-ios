...
-(void) placeholderTextColor{
    if (_floatLabelPassiveColor) {
        self.attributedPlaceholder  = [[NSAttributedString alloc] initWithString:self.placeholder attributes:@{NSForegroundColorAttributeName: _floatLabelPassiveColor}];
    }
...
//    _floatLabelPassiveColor = [UIColor colorWithRed:45.0/255.0 green:67.0/255.0 blue:172.0/255.0 alpha:1.0];
//    _floatLabelActiveColor = [UIColor colorWithRed:45.0/255.0 green:67.0/255.0 blue:172.0/255.0 alpha:1.0];
